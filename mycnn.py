...
def evaluate_lenet5(learning_rate=0.01, n_epochs=200,
    ...
    :type single_image_shape: list of ints
    ...
    layer1_input = x.reshape((batch_size, 1, single_image_shape[0], single_image_shape[1]))
    ...
    layer1 = LeNetConvPoolLayer(
        rng,
        input=layer1_input,
        image_shape=(batch_size, 1, single_image_shape[0], single_image_shape[1]),
        filter_shape=(nkerns[0], 1, window_heigh, single_image_shape[1]),
        poolsize=(single_image_shape[0]-window_heigh+1, 1)
    )
